...
\normalsize GitHub repository: \href{https://github.com/Xiaoxiao-2002/TDLT2026-final-project.git}{https://github.com/Xiaoxiao-2002/TDLT2026-final-project.git}
}
\date{}
...
The companion outline is written in \texttt{docs/FINAL\_SLIDES\_OUTLINE.md}, and it is directly aligned with the final Marp deck in \texttt{docs/final\_slides.marp.md}.
