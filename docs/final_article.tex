...
The companion outline is written in \texttt{docs/FINAL\_SLIDES\_OUTLINE.md}, and it is directly aligned with the final Marp deck in \texttt{docs/final\_slides.marp.md}. The title slide still needs the final GitHub repository URL and confirmed student IDs before submission.
